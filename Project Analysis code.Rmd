...
# 1. BRFSS 2023 data import
```{r}
## ---- load_brfss_2023, message = TRUE, warning = FALSE ------------------

# 1. BRFSS 2023 data import
# -------------------------------------------------------------------
# Before running this code:
#   • Go to: https://www.cdc.gov/brfss/annual_data/annual_2023.html
#   • Download "LLCP2023XPT.zip" (SAS Transport Format)
#   • Unzip the file
#   • Place the extracted file "LLCP2023.XPT" in the same folder
#     as this R Markdown file (your working directory).
#
# This avoids problems with large online downloads timing out or failing during knitting.

library(haven)
library(dplyr)

# 2. Read raw BRFSS 2023 XPT file
# -------------------------------------------------------------------
brfss23 <- haven::read_xpt("LLCP2023.XPT")

# 3. Save a local RDS copy (optional but helpful for future work)
# -------------------------------------------------------------------
# This creates a smaller, faster-to-load version of the dataset.
# Once saved, you can load it in other scripts with:
#   brfss23 <- readRDS("BRFSS2023.rds")


# 4. Quick checks: size and structure
# -------------------------------------------------------------------
dim(brfss23)
